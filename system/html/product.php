        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="page-header">
                  <h1 class="page-title my-auto">Product</h1>
                  <div>
                ...
                <!-- PAGE-HEADER END -->
                <!-- <button type="button" class="btn btn-primary me-2 btn-wave" id="Btn">Primary</button> -->
                <div class="toast-container position-fixed top-0 end-0 p-3">
                    <div id="solid-dangerToast" class="toast colored-toast bg-danger text-fixed-white" role="alert" aria-live="assertive"
                        ...
                        <div class="toast-body">
                            Kamu telah menghapus data dari ID <p class="data-id-hapus"></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card custom-card">
                            <div class="card-header justify-content-between">
                                <div class="card-title">
                                    <a href="edit_product.php?id_product=new" class="btn btn-sm btn-primary-light">Tambah Data<i class="bi bi-plus-lg ms-2 d-inline-block align-middle"></i></a>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive data_product">
