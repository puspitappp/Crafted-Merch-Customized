            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide">
                            <a href="product.php" class="side-menu__item">
                                <i class="bx bx-box side-menu__icon"></i>
                                <span class="side-menu__label">Data Product</span>
                            </a>
                        </li>
                        <li class="slide">
                            <a href="customer.php" class="side-menu__item">
                                <i class="fe fe-users side-menu__icon"></i>
                                <span class="side-menu__label">Data Customer</span>
                            </a>
                        </li>
                        <li class="slide">
                            <a href="cart.php" class="side-menu__item">
                                <i class="ri-shopping-cart-2-line align-middle" style="font-size: 20px;margin-right:7px;"></i>
                                <span class="side-menu__label">Data Cart</span>
                            </a>
                        </li>
                        <!-- End::slide -->
