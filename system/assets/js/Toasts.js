(function () {
  ...
  const solidprimarytoastExample =
    document.getElementById("solid-primaryToast");
  ...
  const solidsecondarytoastExample = document.getElementById(
    "solid-secondaryToast"
  );
  ...
  const solidwarningtoastExample =
    document.getElementById("solid-warningToast");
  ...
  const solidsuccesstoastExample =
    document.getElementById("solid-successToast");
  ...
  const middlecentertoastExample =
    document.getElementById("middlecenter-Toast");
  ...
  const bottomcentertoastExample =
    document.getElementById("bottomcenter-Toast");
